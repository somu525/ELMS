...
$resLeaveAppr = $conn->query("SELECT COUNT(*) AS cnt FROM Leave_Requests WHERE status='submitted'");
  ...
  <div class="row g-3">
    ...
    <div class="col-md-4">
      <a href="departments.php" class="text-decoration-none">
        <div class="card text-center shadow-sm border-primary h-100">
          <div class="card-body">
            <h5 class="card-title text-primary">Departments</h5>
            <p class="display-4 text-primary"><?= $totalDept ?></p>
    ...
    <div class="col-md-4">
      <a href="holidays.php" class="text-decoration-none">
        <div class="card text-center shadow-sm border-primary h-100">
          <div class="card-body">
            <h5 class="card-title text-primary">Holidays</h5>
            <p class="display-4 text-primary"><?= $totalHoli ?></p>
            <p class="card-text">Total</p>
          </div>
        </div>
      </a>
