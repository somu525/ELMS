        ...
        if ($days > 3) {
            ...
            if (!$result) {
                ...
                if ($days > $remaining) {
                    ...
                    if ($stmt->execute()) {
                         echo "<div class='alert alert-success mt-3'>Leave applied successfully. Awaiting manager approval.</div>";
                        echo "<script>setTimeout(() => window.location.href='user_dashboard.php', 2000);</script>";
                    } else {
