...
if (isset($_GET['approve'])) {
    ...
    echo "<div class='alert alert-success mt-3'>Employee Approved</div>";
    echo "<script>setTimeout(() => window.location.href='approve_employee.php', 1000);</script>";
}
...
if (isset($_GET['reject'])) {
    ...
    $_SESSION['toast'] = ['type' => 'info', 'msg' => 'Employee rejected and removed.'];
     echo "<div class='alert alert-danger mt-3'>Employee Rejected</div>";
    echo "<script>setTimeout(() => window.location.href='approve_employee.php', 1000);</script>";
}
...
if (isset($_POST['edit_employee'])) {
    ...
    $stmt->bind_param("ssissi", $name, $email, $dept, $position, $hire_date, $emp_id);
            ...
            echo "<div class='alert alert-success mt-3'>Employee Details Updated</div>";
            echo "<script>setTimeout(() => window.location.href='approve_employee.php', 1000);</script>";
}
...
if (isset($_POST['delete_employee'])) {
    ...
    echo "<div class='alert alert-success mt-3'>Employee removed from company successfully.</div>";
    echo "<script>setTimeout(() => window.location.href='approve_employee.php', 1000);</script>";
}
?>
