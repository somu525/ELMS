...
if (isset($_POST['addHoliday'])) {
    ...
    $stmt->execute();
    echo "<div class='alert alert-success mt-3'>Holiday added successfully.</div>";
    echo "<script>setTimeout(() => window.location.href='holidays.php', 1000);</script>";
}
...
if (isset($_POST['deleteHoliday'])) {
    ...
    $stmt->execute();
    echo "<div class='alert alert-danger mt-3'>Holiday deleted successfully.</div>";
    echo "<script>setTimeout(() => window.location.href='holidays.php', 1000);</script>";
}
?>
<!-- DataTables CSS -->
